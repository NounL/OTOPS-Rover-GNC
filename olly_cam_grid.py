...
class CamGrid(Gtk.Grid):
    ...
    def __init__(self, placement, pipeline_str, sink):
        ...
        # Spans 2 to fit 2 horizontal buttons
        self.outer_cam_grid.attach(self.placeholder,0,0,2,1)
        self.outer_cam_grid.attach(self.inner_cam_grid,0,1,2,1)
    ...
    def on_btn_click(self, widget):
        if not self.pipeline:
            ...
            self.outer_cam_grid.attach(self.widgetSink,0,0,2,1)
