...
const ARM_JOINTS: (keyof ArmStruct)[] = ["base", "elbow", "rotate", "wrist", "gripper"];
...
const ZERO_ARM: ArmStruct = { base: 0, elbow: 0, rotate: 0, wrist: 0, gripper: 0 };
