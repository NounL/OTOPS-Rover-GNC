...
int dirState[NUM_MOTORS] = {1,1,1,1,1,1};
bool motorActive[NUM_MOTORS] = {false};

unsigned long nextStepTimeUs[NUM_MOTORS] = {0};
uint32_t stepIntervalUs[NUM_MOTORS] = {DEFAULT_STEP_INTERVAL_US, DEFAULT_STEP_INTERVAL_US, DEFAULT_STEP_INTERVAL_US, 
                                      DEFAULT_STEP_INTERVAL_US, DEFAULT_STEP_INTERVAL_US, DEFAULT_STEP_INTERVAL_US};
